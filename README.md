...
5 - Ejecutar el siguiente comando : php bin/console make:migration</br>
6 - Ejecutar el siguiente comando : php bin/console doctrine:migrations:migrate</br>
7 - En el navegador de su preferencia intoducir la siguiente direccion : http://localhost/cineverse/public/</br>
